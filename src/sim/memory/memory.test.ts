...
describe('Memory Sanity Test', () => {
    it('Write Test', () => {
        ...
        mem.write(0, 100, callback);
        expect(mem.block[0]).toBe(100);

        mem.write(7, 0xFFFFFFFF, callback);
    ...
    it('Read Test', () => {
        ...
        mem.write(0, 0x3C65FF8E, callback);
        expect(mem.read(0)).toBe(0x3C65FF8E);

        mem.write(7, 0x424265AC, callback);
